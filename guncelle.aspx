                                                            ...
                                                            <asp:Panel ID="pnl" runat="server">
                                                                <div class="form-horizontal" style="margin-top: 15px;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="inputEmail2" class="col-sm-3 text-center">Marka:</label>
                                                                        <label for="inputEmail2" class="col-sm-3 text-center">Model:</label>
                                                                        <label for="inputEmail3" class="col-sm-3 text-center">Yıl:</label>
                                                                        <label for="inputEmail3" class="col-sm-3 text-center">Fiyat:</label>
                                                                    </div>
                                                                    <div class="form-group">
                                                                       
                                                                        <div class="col-sm-3">
                                                                            <asp:TextBox ID="tbmarka" runat="server" CssClass="form-control" ValidationGroup="ekle"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <asp:TextBox ID="tbmodel" runat="server" CssClass="form-control" ValidationGroup="ekle"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <asp:TextBox ID="tbyil" runat="server" CssClass="form-control" ValidationGroup="ekle"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <asp:TextBox ID="tbfiyat" runat="server" CssClass="form-control" ValidationGroup="ekle"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-12 text-center">
                                                                            ...
                                                                            <asp:Button ID="btnkaydet" runat="server" Text="Güncelle" CssClass="btn btn-success" OnClick="btnkaydet_Click" ValidationGroup="ekle" Style="padding: 10px !important; font-size: 16px !important;" />
